...
from lesson.C_GoogLeNet.tools.common_tools import get_googlenet
...
# ============================ step 5/5 训练 ============================
    ...
    for epoch in range(start_epoch + 1, MAX_EPOCH):
        ...
        for i, data in enumerate(train_loader):
            ...
            outputs = googlenet_model(inputs)                       # 观察bn层操作
            ...
            if (i+1) % log_interval == 0:
                ...
                print("Training:Epoch[{:0>3}/{:0>3}] Iteration[{:0>3}/{:0>3}] Loss_main:{:.4f} Acc:{:.2%}".format(
        ...
        if (epoch+1) % val_interval == 0:
            ...
            with torch.no_grad():
                for j, data in enumerate(valid_loader):
                    ...
                    outputs = googlenet_model(inputs.view(-1, c, h, w))     # 观察bn层操作
